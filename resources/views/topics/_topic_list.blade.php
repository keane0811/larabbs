      ...
      <li class="media">
        <div class="media-left">
          <a href="{{ route('users.show', [$topic->user_id]) }}">
            <img src="{{ $topic->user->avatar }}" title="{{ $topic->user->name }}"
              class="media-object img-thumbnail mr-3" style="width: 52px;height: 52px">
          </a>
        </div>
        ...
        <div class="media-body">
          ...
          <small class="media-body meta text-secondary">
            ...
            <a href="{{ route('users.show', [$topic->user_id]) }}" title="{{ $topic->user->name }}"
              ...
              <i class="far fa-user"></i> {{ $topic->user->name }}
            </a>
            <span> ● </span>
            <i class="far fa-clock"></i>
            <span title="最后活跃于: {{ $topic->updated_at }}" class="timeago">
