...
trait ActiveUserHelper
{
    ...
    public function getActiveUsers()
    {
        ...
        // 否则运行匿名函数来取出活跃用户数据, 返回的同时做缓存
        return Cache::remember($this->key, $this->cache_expire_in_seconds, function () {
    ...
    {
        // 从话题表里取出$pass_day时间范围内发表过话题的用户, 同时取出用户此段时间内发布话题的数量
    ...
    {
        // 从回复表里取出$pass_day时间范围内发表过回复的用户, 同时取出用户此段时间内发布回复的数量
